class location_pageObjetModel {
  ...
  aisanoLocationRecord(){
    return cy.get("article[id='locationregionData3'] h4[class='h6']")
  }

  europeNoLocationRecord(){
    return cy.get("article[id='locationregionData2'] h4[class='h6']")
  }
}
